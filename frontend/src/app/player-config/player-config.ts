        ...
        <div class="flex flex-col items-center gap-6">
            ...
            <form>
                <mat-form-field appearance="outline">
                    ...
                    <input matInput placeholder="Your name" [formControl]="playerName" required
            ...
            <button matButton="filled" [disabled]="!playerName.value" (click)="navigateToGame()">Play game</button>
        </div>
    `,
    styles: ``,
})
