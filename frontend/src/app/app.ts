...
@Component({
    ...
    template: `
        <main>
            ...
            <header class="relative flex flex-col sm:flex-row items-center my-4 pb-4 w-full border-b-2 gap-4 sm:gap-0">
                <!-- always center -->
                ...
                <a matButton="outlined" routerLink="/game-records" class="sm:ml-auto sm:mr-4">Game records</a>
            </header>
